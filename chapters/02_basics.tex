...
Dabei wurden die $(3 \times 3)$-Faltungen durch eine effizientere Kombination asymmetrischer $(1 \times 3)$- und $(3 \times 1)$-Convolutions abgelöst.
...
Depthwise Separable Convolution bestehen aus Group Convolution und punktweiser Faltung.
...
Da es in \emph{b} und \emph{c} keine direkte Interaktion zwischen Kanälen unterschiedlicher Gruppen gibt, folgt auf die Group Convolution die punktweise Faltung, die alle Kanäle pro Pixel (mit einem $(1 \times 1)$-Filter) kombiniert und die Dimension der neuen Feature-Map reduziert.
