...
Alle Samples $x$ entsprechen multidimensionalen Matrizen (Tensoren) der Größe $C \times T \times S \times S$, die sich aus $T$ Farbbildern ($C=3$) eines \glspl{clip} zusammensetzen.
