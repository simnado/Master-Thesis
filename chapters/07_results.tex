...
Während Aktionen wie \code{corner}, \code{footShot} oder \code{throwIn} sehr durchgehend gute Ergebnisse vorweisen, wurden andere Klassen wie \code{offside} oder \code{handball} praktisch gar nicht zu klassifizieren erlernt.
