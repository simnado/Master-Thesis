...
Die Zuordnung von Aktionen zu einem Teil-Datenset (\code{split}, hier: Trainings-, Validierungs-, Test-Set) geschieht Spiel-übergreifend.
...
Der Nullpunkt wird als \code{startTime} gespeichert, während sich die \code{endTime} aus Startzeit und Dauer der Halbzeit ergibt, wobei die Halbzeitdauer wiederum in den \gls{sbod}-Annotationen enthalten ist.
...
Mit dem Selektor können alle Annotationen dieser Klasse in einem Zug aus den \gls{sbod}-Annotationen eines Spiels gefiltert werden.
