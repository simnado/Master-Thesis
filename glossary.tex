...
\newglossaryentry{sample}{
  name = {Sample},
  sort = {Sample},
  description = {Datensatz aus Features und Label $(x_i, y_i)$}
}
...
\newglossaryentry{tld:L}{%
	type=symbols,
	name={L},
	description={Anzahl Schichten innerhalb eines Neuronalen Netzes}
}
\newglossaryentry{tld:N}{%
	type=symbols,
	name={M},
	description={Anzahl Trainingsdaten}
}
...
\newglossaryentry{tld:x}{%
	type=symbols,
	name={x},
	description={Input-Vektor (Tensor)}
}
\newglossaryentry{tld:y}{%
	type=symbols,
	name={y},
	description={Label, bekannter Zielwert}
}
