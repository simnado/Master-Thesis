...
\include{util//abbreviations}
\include{util//lst_json}
...
\firstSupervisor{Prof. Dr. rer. nat. Joachim Hertzberg}
\secondSupervisor{Dr. rer. nat. Isabel Hübener}
...
\printglossary[type=symbols, title=Symbolverzeichnis, toctitle=Symbolverzeichnis, nonumberlist]
...
\include{chapters//03_sota}
\include{chapters//04_concept}
\include{chapters//05_data}
\include{chapters//06_training}
\include{chapters//07_results}
%\include{chapters//08_integration}
